...
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang-10 -cflags "-O2 -g -Wall -Werror" -target bpfel,bpfeb bpf af_xdp_kern.c -- -I /home/ubuntu/MasterThesis/preoven-thesis/libbpf/src
